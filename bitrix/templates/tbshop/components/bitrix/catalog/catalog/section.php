...
if (!empty($arResult['VARIABLES']['SECTION_ID']))
    $arSecFilter['ID'] = $arResult['VARIABLES']['SECTION_ID'];
if (!empty($arResult['VARIABLES']['SECTION_CODE']))
    $arSecFilter['CODE'] = $arResult['VARIABLES']['SECTION_CODE'];

if (!empty($arSecFilter)) {
    $arSecFilter['IBLOCK_ID'] = $arParams['IBLOCK_ID'];
    $arCurrentSection = \CIBlockSection::GetList([], $arSecFilter, false, ['ID', 'NAME'])->fetch();
}

$secName = !empty($arCurrentSection['NAME']) ? $arCurrentSection['NAME'] : 'Каталог товаров';
?>
<div class="container">
    <div class="row">
        <div class="filter-wrap col-3 d-none d-md-block">
            ...
            $APPLICATION->IncludeComponent(
                ...
                "IBLOCK_TYPE" => $arParams["IBLOCK_TYPE"],
                "IBLOCK_ID" => $arParams["IBLOCK_ID"],
                "SECTION_ID" => $arCurrentSection['ID'],
        ...
        <div class="col-12 col-md-9">
            <h1 class="mt-5"><?= $secName; ?> <? $APPLICATION->ShowViewContent('title_counter'); ?></h1>
            ...
            ?>
            <?
            $APPLICATION->IncludeComponent("bitrix:catalog.section.list", "catalog.section", array(
            ...
            <div class="mt-5">
                <?
                $APPLICATION->IncludeComponent(
                        "bitrix:catalog.section", "tabs", array(
