...
?>
    ...
    <? } ?>
        <div class="mt-5 text-right">
            <a class="btn btn-md btn-secondary" href="<?= $arResult['SEF_DEL_FILTER_URL']; ?>">Сбросить</a>
            <button class="btn btn-md btn-primary" href="<?= $arResult['FILTER_URL']; ?>">Применить</button>
        </div>
    </form>
<? } ?>
<?
